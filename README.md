...
- modifier _ avec le filename du execve
- si premier entre guillement cas spécial ou refaire tout le parsing
- listes des var d'environnement : GJS_DEBUG_TOPICS SSH_AUTH_SOCK SESSION_MANAGER GNOME_TERMINAL_SCREEN SSH_AGENT_PID XDG_CURRENT_DESKTOP LANG LC_IDENTIFICATION DEFAULTS_PATH XDG_SESSION_CLASS COLORTERM QT_IM_MODULE GPG_AGENT_INFO DESKTOP_SESSION USER XDG_MENU_PREFIX HOME GJS_DEBUG_OUTPUT LC_MEASUREMENT DBUS_SESSION_BUS_ADDRESS PWD LC_NUMERIC GTK_MODULES _ WINDOWPATH XDG_SESSION_DESKTOP JOURNAL_STREAM QT_ACCESSIBILITY GNOME_DESKTOP_SESSION_ID MANAGERPID LC_TIME MANDATORY_PATH LOGNAME GNOME_TERMINAL_SERVICE LC_PAPER PATH XDG_RUNTIME_DIR XDG_DATA_DIRS XMODIFIERS XDG_SESSION_TYPE LC_MONETARY GNOME_SHELL_SESSION_MODE LC_TELEPHONE USERNAME XDG_CONFIG_DIRS VTE_VERSION INVOCATION_ID SHLVL SHELL XAUTHORITY LC_NAME IM_CONFIG_PHASE TERM LC_ADDRESS DISPLAY GDMSESSION OLDPWD ZSH PAGER LESS LSCOLORS LS_COLORS
- export file="a b c d" not working
